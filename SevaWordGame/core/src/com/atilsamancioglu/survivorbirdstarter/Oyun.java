...
public class Oyun extends ApplicationAdapter {
    ...
    Color[] colors = {Color.BLUE,Color.SKY, Color.RED, Color.ORANGE, Color.YELLOW, Color.PINK, Color.PURPLE, Color.GREEN, Color.ROYAL, Color.SALMON, Color.NAVY};
    SpriteBatch batch;
    ...
    public void create() {
        ...
        background= new Texture("resim.png");
        batch = new SpriteBatch();
        shapeRenderer = new ShapeRenderer();
        font = new BitmapFont();
        label= new Label("hellüü", new Label.LabelStyle(font, Color.DARK_GRAY));
        ...
        Texture buttonTexture = new Texture(Gdx.files.internal("mavi.png"));
        TextureRegionDrawable buttonDrawable = new TextureRegionDrawable(new TextureRegion(buttonTexture));
        buttoncross = new ImageButton(buttonDrawable);
        buttoncross.setPosition(880, 1770);
        ...
        Texture buttonTexture2 = new Texture(Gdx.files.internal("pembe.png"));
...
//arka plana resim ekleme
       ...
       batchson.end();
        ...
        for (int i = 0; i < circles.size(); i++) {
            ...
            shapeRenderer.setColor(colors[1]); // renkleri sırayla döndürmek için i%8 kullanılıyor
        ...
        if (Gdx.input.justTouched()) {
            ...
            for (int i = 0; i < circles.size(); i++) {
                ...
                if (circle.contains(touchX, touchY)) {
                    ...
                    label.setPosition(stage.getWidth() - 880, stage.getHeight() - 180);
    ...
    public void toplamhesapla(String aranan, String letter) {
        ...
        if (sonuc == 0) { // simdi a eslesen ya a daki karaktrlerde charatle kac tane var
            ...
            label2 = new Label("PUAN:" + str, new Label.LabelStyle(font, Color.WHITE));
            label2.setPosition(stage.getWidth() - 500, stage.getHeight() - 220);
